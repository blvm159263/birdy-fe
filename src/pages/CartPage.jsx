    ...
    <div id="cardPage" className="bg-neutral-100 py-6 pb-12">
      ...
      <section className="container mx-auto">
        <div className="grid grid-cols-9 text-center bg-white rounded-sm p-2">
          ...
          <div className="col-span-3 text-left font-bold">Sản phẩm</div>
          <div className="col-span-1">Loại</div>
          <div className="col-span-1">Giá</div>
          <div className="col-span-1">Số lượng</div>
          <div className="col-span-1 font-bold">Tổng</div>
        ...
        <div className="bg-white rounded-sm mt-4 grid grid-cols-9 items-center text-center p-2 drop-shadow-sm">
          ...
          <div className="col-span-2 text-red-500 font-bold">
            {totalSelectedProduct === 0 ? (
              ...
              <button
                onClick={() =>
                  dispatch(setShowCartDeleteAllSelectedModal(true))
                }
              >
          ...
          <div className="col-span-3 flex lg:flex-row sm: flex-col">
            Tổng (<span className="font-bold">{totalSelectedProduct}</span> sản
            phẩm):{" "}
            <span className="font-bold">${totalSelectedPrice.toFixed(2)}</span>
          </div>
          <div className="col-span-2">
            {totalSelectedProduct === 0 ? (
              <span className="py-1 px-4 flex lg:w-4/6 sm: w-full rounded-sm text-white bg-gradient-to-r from-neutral-500 via-neutral-600 to-neutral-400">
                Thanh toán
              </span>
            ) : (
              <Link
                to="/cart/checkout"
                className="py-1 px-4 flex lg:w-4/6 sm: w-full rounded-sm text-white bg-gradient-to-r from-sky-500 via-sky-600 to-sky-400"
              >
                Thanh toán
              </Link>
            )}
