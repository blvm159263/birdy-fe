    ...
    <div id='ViewShopPage' className='bg-neutral-100 px-2 md:px-0 py-4'>
      <section className='container mx-auto'>
        ...
        <ul className={'bg-white rounded-sm flex justify-between px-24 py-2'}>
          ...
          <li><Link to={`/view-shop/${id}`}>All products</Link></li>
          <li><Link to={`/view-shop/${id}`}>Latest</Link></li>
          <li><Link to={`/view-shop/${id}`}>Birds</Link></li>
          <li><Link to={`/view-shop/${id}`}>Accessories</Link></li>
          <li><Link to={`/view-shop/${id}`}>Foods</Link></li>
        </ul>
