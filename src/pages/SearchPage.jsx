...
export default function SearchPage() {
  ...
  return (
    <div id='searchPage' className='bg-neutral-100 px-2 md:px-0'>
      <div className='flex justify-center py-6'>
        <Link to="/search" className='text-sm md:text-xl font-bold uppercase active text-sky-500'>All</Link>
        <span className='text-neutral-400 text-sm md:text-xl font-bold mx-2 md:mx-8'>/</span>
        <Link to="/search" className='text-sm md:text-xl font-bold uppercase'>Bird</Link>
        <span className='text-neutral-400 text-sm md:text-xl font-bold mx-2 md:mx-8'>/</span>
        <Link to="/search" className='text-sm md:text-xl font-bold uppercase'>Accessories</Link>
        <span className='text-neutral-400 text-sm md:text-xl font-bold mx-2 md:mx-8'>/</span>
        <Link to="/search" className='text-sm md:text-xl font-bold uppercase'>Decor</Link>
      </div>
