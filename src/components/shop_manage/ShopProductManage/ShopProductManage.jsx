  ...
  const fetchProductForShop = () => {
    ...
    if (shopId) {
      ...
      switch (searchCategory) {
        case "ALL_PRODUCTS":
          apiPromise = shopManageApi.getShopProductsByShopIdForShopManage(
            shopId,
            params
          )
          break
        case "LATEST":
          apiPromise = shopManageApi.getLatestShopProductsByShopIdForShopManage(
            shopId,
            params
          )
          break
        case "BIRDS":
          apiPromise =
            shopManageApi.getShopProductsByShopIdAndCategoryIdForShopManage(
              shopId,
              1,
              params
            )
    ...
    <div className="bg-gray-200 p-4 col-span-9 min-h-screen">
      ...
      <div className="flex gap-2">
        ...
        <ul className="category-bar flex h-full gap-1 items-baseline">
          ...
          <li>
            <button
              onClick={() => changeSearchCategory("ALL_PRODUCTS")}
              className={`rounded p-2 ${
                searchCategory === "ALL_PRODUCTS"
                  ? "text-white bg-sky-500 font-bold shadow"
          ...
          <li>
            <button
              onClick={() => changeSearchCategory("LATEST")}
              className={`rounded p-2 ${
          ...
          <li>
            <button
              onClick={() => changeSearchCategory("BIRDS")}
              className={`rounded p-2 ${
                searchCategory === "BIRDS"
                  ? "text-white bg-sky-500 font-bold shadow"
                  : "border border-neutral-300"
              }`}
            >
          ...
          <li>
            <button
              onClick={() => changeSearchCategory("ACCESSORIES")}
              className={`rounded p-2 ${
          ...
          <li>
            <button
              onClick={() => changeSearchCategory("FOODS")}
              className={`rounded p-2 ${
