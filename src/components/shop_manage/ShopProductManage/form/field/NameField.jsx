  ...
  return (
    <div className="mb-4">
      ...
      <div className="flex flex-wrap items-stretch w-full relative">
        <input type="text" id="name" value={productName} onChange={(e) => dispatch(updateProductFormValues({productName: e.target.value}))} maxLength={120} required name="name" placeholder="Loading"
