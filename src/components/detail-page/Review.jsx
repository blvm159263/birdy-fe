      ...
      <div id="reviews">
        <div id="review-1" className="my-5">
          ...
          <p>
            ...
            temporibus repellendus id velit necessitatibus facere,
          </p>
        </div>
        <div id="review-2" className="my-5">
          <div className="flex">
            <div className="h-10 w-10 mr-3">
              <img src="/assets/images/shop_avar.png" alt="" />
            </div>
        ...
        <div id="review-3" className="my-5">
          <div className="flex">
            <div className="h-10 w-10 mr-3">
              <img src="/assets/images/shop_avar.png" alt="" />
            </div>
        ...
        <div id="viewAlls" className="flex justify-center items-center pt-10">
