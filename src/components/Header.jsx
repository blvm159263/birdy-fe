    ...
    <nav className="bg-gradient-to-r from-sky-500 via-blue-500 to-sky-500 border-gray-200">
      <div className="container flex flex-wrap items-center justify-between mx-auto p-3 md:px-8 md:py-6 lg:py-4 relative">
        <Link to="/" className="flex items-center">
          <img src="/assets/images/logo-white.png" className="h-8 md:h-12 mr-3" alt="Birdy Logo" />
          <span className="self-center text-xl md:text-3xl lg:text-4xl font-semibold whitespace-nowrap dark:text-white">Birdy</span>
        </Link>
